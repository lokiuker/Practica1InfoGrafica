...
extern void GLinit(int width, int height, double  currentTime);
extern void GLcleanup();
extern void GLrender(double currentTime, bool, bool, bool,bool);
...
int main(int argc, char** argv) {
	...
	// Init scene
	GLinit(display_w, display_h, currentTime);
	//PhysicsInit();
	...
	bool quit_app = false;
	bool ejercicio1 = false;
	bool ejercicio2a = false;
	bool ejercicio2b = false;
	bool ejercicio3 = false;
	...
	while (!quit_app) {
		...
		GLrender(currentTime, ejercicio1, ejercicio2a, ejercicio2b, ejercicio3);
